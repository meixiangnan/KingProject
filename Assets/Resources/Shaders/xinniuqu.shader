...
Shader "myshader/xinniuqu" {
	Properties{
		_MainTex("Base (RGB)", 2D) = "white" {}
		_MainTex_ST("Texture Size", vector) = (256, 256, 0, 0)
		_MainTex_TexelSize("Texture Size0", vector) = (256, 256, 0, 0)
		_Angle("Vortex Angel", Range(0, 360)) = 0
		_CenterRadius("Texture Size1", vector) = (0.5, 0.5, 0.5, 0.5)
	}
