...
public sealed partial class AutoImport1 : Luban.BeanBase
{
    public AutoImport1(JSONNode _buf) 
    {
        ...
        { if(!_buf["v2"].IsObject) { throw new SerializationException(); }  V2 = ExternalTypeUtil.NewVector2(global::cfg.vec2.Deserializevec2(_buf["v2"]));  }
        ...
        { var __json0 = _buf["k10"]; if(!__json0.IsArray) { throw new SerializationException(); } K10 = new System.Collections.Generic.List<UnityEngine.Vector3>(__json0.Count); foreach(JSONNode __e0 in __json0.Children) { UnityEngine.Vector3 __v0;  { if(!__e0.IsObject) { throw new SerializationException(); }  __v0 = ExternalTypeUtil.NewVector3(global::cfg.vec3.Deserializevec3(__e0));  }  K10.Add(__v0); }   }
        { var __json0 = _buf["k11"]; if(!__json0.IsArray) { throw new SerializationException(); } K11 = new System.Collections.Generic.List<UnityEngine.Vector4>(__json0.Count); foreach(JSONNode __e0 in __json0.Children) { UnityEngine.Vector4 __v0;  { if(!__e0.IsObject) { throw new SerializationException(); }  __v0 = ExternalTypeUtil.NewVector4(global::cfg.vec4.Deserializevec4(__e0));  }  K11.Add(__v0); }   }
        { var _j = _buf["v11"]; if (_j.Tag != JSONNodeType.None && _j.Tag != JSONNodeType.NullValue) { { if(!_j.IsObject) { throw new SerializationException(); }  V11 = ExternalTypeUtil.NewVector3(global::cfg.vec3.Deserializevec3(_j));  } } else { V11 = null; } }
    }
