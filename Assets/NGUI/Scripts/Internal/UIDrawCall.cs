...
public class UIDrawCall : MonoBehaviour
{
    ...
    public delegate void onSortingOrderChange(int value);
    public onSortingOrderChange onSortingChange;
    public int mLastRenderQueue = -1;
    private int mLastSortingOrder = 1;
    public UIWidget w;
    /// <summary>
    ...
    public int renderQueue
    {
        ...
        set
        {
            ...
            if (value != mLastRenderQueue && onSortingChange != null)
            {
                //if(mMaterial!=null)
                //Debug.Log("mm=="+mMaterial.name);
                onSortingChange(value);
                mLastRenderQueue = value;
            }
        }
    }
    ...
    public int sortingOrder
    {
        ...
        set
        {
            ...
            if (value != mLastSortingOrder && onSortingChange != null)
            {
                onSortingChange(value);
                mLastSortingOrder = value;
            }
        }
    }
    ...
    void OnWillRenderObject()
    {
        ...
        if (mBlock != null&&mRenderer!=null) mRenderer.SetPropertyBlock(mBlock);
